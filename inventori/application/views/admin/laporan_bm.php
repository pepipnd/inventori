	<div class="container-fluid">
		...
		<!-- Page Heading -->
		<h1 class="h3 mb-4 text-gray-800">Laporan Pengembalian Barang</h1>
		...
		<div class="row">
			...
			<div class="col-lg-12">
				...
				<div class="card shadow mb-12">
					<div class="card-body">
						<h5>Laporan Pengembalian Barang Berdasarkan Tanggal</h5>
						<hr>
						<form method="POST" action="<?=base_url('Admin/print_bm')?>" target='_blank'>
				...
				<div class="card shadow mb-12">
					<div class="card-body">
						<h5>Laporan Pengembalian Barang Berdasarkan Bulan</h5>
						<hr>
						<form method="POST" action="<?=base_url('Admin/print_bm')?>" target='_blank'>
				...
				<div class="card shadow mb-12">
					<div class="card-body">
						<h5>Laporan Pengembalian Barang Berdasarkan Tahun</h5>
						<hr>
						<form method="POST" action="<?=base_url('Admin/print_bm')?>" target='_blank'>
